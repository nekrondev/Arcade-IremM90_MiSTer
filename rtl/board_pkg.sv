...
package board_pkg;
    ...
    parameter region_t REGION_SOUND_SAMPLES = '{ base_addr:'h060_0000, reorder_64:0, bram_cs:5'b00000 }; // SDRAM (after GFX @0x400000+2MB); was BRAM but 256KB samples don't fit on-chip
